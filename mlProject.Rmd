...
```
##Model Validation
The model can be applied to the test set and compared to the known test set classe variable for cross-validation.  A confusion matrix is used to compare the two vectors.  The confusion matrix shows the out-of-sample error rate to be 2%, and with 95% confidence predicts the accuracy of this model to be between 97.68% and 98.31%.
